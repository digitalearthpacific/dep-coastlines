...
ogr2ogr $output -dialect sqlite tmp.gpkg -nln coastlines -sql "select year as year, st_union(geom) as geom from coastlines where eez_territory = 'Fiji' group by year"
# rm tmp.gpkg
