...
output_exploded=${ODIR}/coastlines_${version}_exploded.gpkg
...
mkdir -p $tile_folder
tippecanoe -e $tile_folder/coastlines -pi -z 13 -l coastlines $output_geojson --force

ogr2ogr -nlt MULTILINESTRING $output_exploded $tile_folder/coastlines/13
